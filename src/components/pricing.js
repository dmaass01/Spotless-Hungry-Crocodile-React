...
Pricing.defaultProps = {
  plan1Feature2: 'Automated email responses',
  ...
  plan1Feature3: 'Email analytics dashboard',
  ...
  plan2Feature2: 'Advanced email prioritization',
  plan3Feature3: 'Integration with CRM systems',
